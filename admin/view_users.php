                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" value="<?= $row['transMsg'] ?>" name="transMsg" placeholder="<?= $row['transMsg'] ?>"><?=$page['default_transMsg']?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
